...
import com.blackjackquiz.app.ui.fragments.ResponseGameFragment;
...
public class BlackJackQuizActivity extends Activity implements CountDialogFragment.CountRestartCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_responseGameFragment = new ResponseGameFragment();

        s_blackJackActivity = this;
        s_currentFragment = R.id.response_game;
        ...
        getFragmentManager().beginTransaction()
                ...
                .add(R.id.container, m_responseGameFragment, getResources().getString(R.string.tag_responseGameFragment))
    ...
    public void restartCount() {
        switch (s_currentFragment) {
            ...
            case R.id.complete_game:
                ...
                break;
            case R.id.response_game:
                ResponseGameFragment responseGameFragment = (ResponseGameFragment) getFragmentManager()
                        .findFragmentByTag(getResources().getString(R.string.tag_responseGameFragment));
                responseGameFragment.newField();
                break;
            default:
                break;
        }
    ...
    public void handleMediaKeyEvent(KeyEvent keyEvent) {
        ...
        m_responseGameFragment.handleKeyEvent(keyEvent);
    }
    ...
    private ResponseGameFragment m_responseGameFragment;
